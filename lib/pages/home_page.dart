...
import 'package:news_app/providers/ekonomi_new_provider.dart';
import 'package:news_app/providers/nasional_new_provider.dart';
              ...
              Consumer<TechNewsProvider>(
                builder: (context, techNews, child) {
                  if (techNews.isLoading) {
                    ...
                    return const Text('ada apa gerangan');
                  } else {
